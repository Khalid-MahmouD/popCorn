  ...
  return (
    <div className="text-center relative">
      <div role="status">
        <svg
          aria-hidden="true"
          className="inline w-40 h-40 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
          viewBox="0 0 100 101"
          fill="none"
...
function MovieDetails({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  return (
    <div
      className={
        isLoading ? "h-full flex items-center justify-center" : "details"
      }
    >
      {isLoading ? (
        <Loader />
  ...
  return (
    <li key={movie.imdbID}>
      ...
      <img
        onError={(e) =>
          (e.target.src =
            "https://images.pexels.com/photos/7234396/pexels-photo-7234396.jpeg?auto=compress&cs=tinysrgb&w=600")
        }
        src={movie.poster}
        alt={`${movie.title} poster`}
      />
